...
Com a porta 21 (FTP) confirmada como aberta, o próximo passo foi usar o **Medusa** para realizar um ataque de força bruta, testando as credenciais padrão que criei nas minhas wordlists.
...
**Resultado (Evidência)**
```
O Medusa teve sucesso em encontrar uma credencial válida, como mostrado no log abaixo:
